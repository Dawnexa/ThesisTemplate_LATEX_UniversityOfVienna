...
\Who{ My name } %Make sure you add all your titles! 
% A name exceeding one line can be created using the \WhoTwo command
%\WhoTwo{ FirstName \\ LastName }
\Degree{Bachelor of Science (BSc)}
\Year{2025}
\ProgrammeCode{000 000}
\ProgrammeName{Bachelorstudium} %Make sure it has the same Name as in the Studienblatt
\Supervisor{Betreuer}
%\SupervisorTwo{Second Row} % Here you can change the row under the supervisor
\SetCoSupValue{0} % Set to 1 if you have a Co Supervisor
